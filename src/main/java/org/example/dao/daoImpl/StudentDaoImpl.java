...
public class StudentDaoImpl implements StudentDao {
    ...
    public List<Student> getAllStudents() {
        ...
        String sql="select * from students3";
        try (Connection connection=Config.getConnection();
             Statement statement = connection.createStatement()){
    ...
    public void updateStudent(Long id, Student student) {
        String sql="" +
                "update students3 set first_name=?,last_name=?,age=? where id=?";
        try ( Connection connection=Config.getConnection();
              PreparedStatement preparedStatement=connection.prepareStatement(sql)){
            preparedStatement.setString(1, student.getFirst_name());
            preparedStatement.setString(2, student.getLast_name());
    ...
    public void cleanTable() {
        String sql="truncate table students3";
        try (Connection connection=Config.getConnection();
             Statement statement=connection.createStatement()){
            statement.executeUpdate(sql);
    ...
    public void dropTable() {
        String sql="drop table students3";
        try(Connection connection=Config.getConnection();
        Statement statement=connection.createStatement()){
            statement.executeUpdate(sql);
